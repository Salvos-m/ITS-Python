...
def display_message(argomento):
    return(f"sta studiando le {argomento}")

print(display_message("funzioni"))

#oppure
'''def display_message(argomento):
    print(f"sta studiando le {argomento}")

display_message("funzioni")'''