'''
Esercizio 3C-00B. Scrivere un programma in Python che chieda 
all'utente di inserire il proprio nome e il proprio genere 
(specificato con "m" per maschio o "f" per femmina) e utilizzi 
lo statement match per fornire una risposta adeguata da inserire 
in un documento di identita'.
...
Mi dispiace Alex, non e' possibile procedere con la generazione 
di un documento di identità!
'''

nome=input("inserisci il tuo nome: ")
genere=input("inserire genere, m per maschio e f per femmina: ")
